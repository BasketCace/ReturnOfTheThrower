...
namespace ReturnOfTheThrower.Content.Projectiles
{
    public class JarateProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int num575 = Dust.NewDust(Projectile.Center + vector51 - Vector2.One * 5f, 4, 4, DustID.IchorTorch);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                Dust.NewDust(Projectile.Center - vector43 / 2f, (int)vector43.X, (int)vector43.Y, DustID.GemTopaz, 0f, 0f, 0, Color.Red);
            }
            ...
            {
                int num411 = Dust.NewDust(Projectile.Center - vector43 / 2f, (int)vector43.X, (int)vector43.Y, DustID.IchorTorch, 0f, 0f, 100, default(Color), 2.5f);
                Main.dust[num411].noGravity = true;
                Dust dust = Main.dust[num411];
                dust.velocity *= 5f;
                num411 = Dust.NewDust(Projectile.Center - vector43 / 2f, (int)vector43.X, (int)vector43.Y, DustID.IchorTorch, 0f, 0f, 100, default(Color), 1.5f);
            ...
            if (Main.myPlayer == Projectile.owner)
            {
                for (int num412 = 0; num412 < 6; num412++)
                {
                    ...
                    var fire = ModContent.ProjectileType<JarateFire1>();

                    var firetype = Main.rand.Next(3);
                    switch (firetype)
                    {
                        case 0:
                            fire = ModContent.ProjectileType<JarateFire1>();
                            break;
                        case 1:
                            fire = ModContent.ProjectileType<JarateFire2>();
                            break;
                        case 2:
                            fire = ModContent.ProjectileType<JarateFire3>();
                            break;
                    }
    ...
    public class JarateFire1 : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Jarate");
        ...
        public override void AI()
        {
            ...
            int num157 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.IchorTorch, 0f, 0f, 100);
            ...
            {
                int num158 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.IchorTorch, 0f, 0f, 100);
    ...
    public class JarateFire2 : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Jarate");
    ...
    public class JarateFire3 : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Jarate");
